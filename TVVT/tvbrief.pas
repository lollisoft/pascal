...
uses Dos, Objects, Drivers, Memory, Views, Menus, Dialogs,
  StdDlg, MsgBox, App, Calc, Buffers, Editors, GadGets,
...
begin
  ...
  MenuBar := New(PMenuBar, Init(R, NewMenu(
    NewSubMenu('~D~atei', hcNoContext, NewMenu(
      ...
      NewItem('Speichern ~a~ls...', '', kbNoKey, cmSaveAs, hcNoContext,
      NewLine(
      NewItem('~W~echsle verzeichnis', '', kbNoKey, cmChangeDir, hcNoContext,
    ...
    NewSubMenu('~E~ditieren', hcNoContext, NewMenu(
      ...
      nil))))))))),
    NewSubMenu('~S~uche', hcNoContext, NewMenu(
      NewItem('~F~inden...', '', kbNoKey, cmFind, hcNoContext,
      NewItem('~E~rsetzen...', '', kbNoKey, cmReplace, hcNoContext,
      NewItem('~W~eiter suchen', '', kbNoKey, cmSearchAgain, hcNoContext,
      nil)))),
    NewSubMenu('~F~enster', hcNoContext, NewMenu(
      NewItem('~G~r”áe/„ndern','Ctrl-F5', kbCtrlF5, cmResize, hcNoContext,
      NewItem('~Z~oom', 'F5', kbF5, cmZoom, hcNoContext,
      NewItem('~T~ile', '', kbNoKey, cmTile, hcNoContext,
      NewItem('C~a~scade', '', kbNoKey, cmCascade, hcNoContext,
      NewItem('~N~„chstes Fenster', 'F6', kbF6, cmNext, hcNoContext,
      NewItem('~L~etztes  Fenster', 'Shift-F6', kbShiftF6, cmPrev, hcNoContext,
      NewItem('~F~enster schlieáen', 'Alt-F3', kbAltF3, cmClose, hcNoContext,
      NewLine(
      NewItem('~R~echner', '', kbNoKey, cmCalculator, hcNoContext,
      nil)))))))))),
...
begin
  ...
  New(StatusLine, Init(R,
    NewStatusDef(0, $FFFF,
      ...
      NewStatusKey('~Alt-F3~ Fenster schlieáen', kbAltF3, cmClose,
      NewStatusKey('~F5~ Zoom', kbF5, cmZoom,
      NewStatusKey('~F6~ N„chstes Fenster', kbF6, cmNext,
