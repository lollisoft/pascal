...
Uses
   (*  TvGraph,*)    (* Grafikbildschirm *)
     TVDVDATA, TVCURSOR, Overlay, TvdvCmds, HelpCmds, HelpFile, Crt, Dos,
     Objects, Memory, GadGets, Drivers, Views, Menus, Dialogs, MsgBox,
     LabHist, Editors, Editor, Strings, Colors, App, TVDVImp, FileFind,
     FileShow, DEdit, StdDlg, StrTools, DDN, EMS, XMS, XHeap, IdleKey;
Type
...
{$EndIF}
  ...
  R.Assign (13, 7, 40, 8);
  Dialog^.Insert (New (pStaticText, Init (R, 'Copyright (c) 1993, 2023 by')));
  R.Assign (14, 10, 30, 11);
