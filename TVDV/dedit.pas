...
Begin
  ...
  Begin
    ...
    MsgRes := Message(TopView, evBroadCast, cmWindowListItemSelected, @Self);
...
BEGIN
  ...
  Insert (AInputLine);
  R.Assign (20, 5, 33, 6);
  Insert (New (pLabel, Init (R, '~Z~u suchen:', AInputLine)));
  R.Assign (45, 6, 48, 7);
  Insert (New (pHistory, Init  (R, pInputLine (AInputLine), 0)));
    ...
    Case Lauf.Ptr^.StrucktData.Art of
      ...
      3 : Begin
            ...
            PLabelCollection(ALabelDateiListBox^.List)^.
              ...
              Insert(@Lauf.Ptr^.StrucktData.DateiList.Ptr^.
    ...
    Case Lauf.Ptr^.StrucktData.Art of
      ...
      2 : Begin
            ...
            PPfadCollection(APfadListBox^.List)^.
              ...
              Insert(@Lauf.Ptr^.StrucktData.PfadList.Ptr^.
...
Begin
  ...
  If Lauf.Ptr = nil Then Wait('Keine Daten vorhanden.');
    ...
    Case Lauf.Ptr^.StrucktData.Art of
      ...
      1 : Begin
            ...
            PLabelCollection(ALabelDateiListBox^.List)^.
              ...
              Insert(@Lauf.Ptr^.StrucktData.LabelList.Ptr^.
...
Begin
  ...
  MsgRes := Message(TopView, evBroadCast, cmPressRadioButton, @Item)
...
begin
  ...
  If (Anfang.Ptr = Element.Ptr) and
    ...
    Element.Ptr^.Next;                   (* Element zeigen lassen:      *)
  ...
  If (Ende.Ptr = Element.Ptr) and
    ...
    Element.Ptr^.Next.Ptr^.Back := Element.Ptr^.Back;(* Element zeigen lassen:      *)
  ...
  begin
    ...
    begin
      ...
      Begin
        ...
        Writeln('Anzahl: ', Lauf.Ptr^.StrucktData.DateiList.Ptr^.DateiData.Anzahl);

        Writeln('Datei : ', Lauf.Ptr^.StrucktData.DateiList.Ptr^.DateiData.DateiName);
...
begin
  ...
  While (DiskName <> HilfLauf.Ptr^.HilfData.LabelList.Ptr^.

                     StrucktData.LabelList.Ptr^.LabelData.LabelName) and

        (HilfLauf.Ptr <> Nil) do

    HilfLauf := HilfLauf.Ptr^.Next;
...
Begin
  ...
  Case Event.Command of
    ...
    cmDEDITDiskBereichLoeschen : Begin
                                   ...
                                   Wait('Es kann vorerst nur bei geladenen ' +

                                        'Daten ein Diskbereich gelîsch werden.')
